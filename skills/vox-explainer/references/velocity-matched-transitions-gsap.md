...
Canonical implementations for every variant. Parameters and rules live in
...
/ `__T__` / `__DUR__` tokens — see
[render-safe-seams.md](render-safe-seams.md) for the token table).
